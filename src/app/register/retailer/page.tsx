  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-red-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-2xl w-full space-y-8">
        ...
        {/* Step 2: Payment */}
        {step === 2 && (
          <div className="bg-white p-8 rounded-xl shadow-xl border border-red-200 animate-slide-in-right">
            <h3 className="text-2xl font-bold text-red-800 mb-6 text-center">💳 Step 2: Payment</h3>
            
            <div className="bg-gradient-to-r from-red-50 to-orange-50 p-6 rounded-xl border-2 border-red-200 mb-6">
              <div className="text-center">
                <div className="text-6xl mb-4">💰</div>
                <h4 className="text-3xl font-bold text-red-800 mb-2">₹{registrationFee.toFixed(2)}</h4>
                <p className="text-red-600 font-medium">Registration Fee</p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 mb-6">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                ...
                <li>• Admin approval after successful payment</li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={() => setStep(1)}
                disabled={isLoading || paymentLoading}
                className="w-full py-3 px-6 border-2 border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition-all duration-200"
              >
                ← Back to Details
              </button>
            </div>
