...
export default function PublicMobilePostpaidPage() {
  ...
  useEffect(() => {
    ...
    if (status === 'authenticated') {
      router.push('/dashboard/recharge/mobile-postpaid');
    }
  }, [status, router]);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Please login to access mobile postpaid bill payment services with instant processing and real-time status updates.
          </p>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 text-center shadow-lg">
            ...
            <p className="text-gray-600 text-sm">
              Fetch your bill details before payment for supported operators
            </p>
          </div>
          
          <div className="bg-white rounded-xl p-6 text-center shadow-lg">
            <div className="text-3xl mb-4">🎯</div>
            <h3 className="text-lg font-semibold mb-2">Manual Selection</h3>
            <p className="text-gray-600 text-sm">
              Choose your operator and circle manually for accurate processing
            </p>
          </div>
