                  ...
                  >
                    {service.image_url && (
                      <div className="relative h-48 w-full overflow-hidden rounded-t-lg">
                        ...
                        <div className="absolute top-2 right-2 z-0">
                          <div
                            className={`px-4 py-1 rounded-full text-base font-bold shadow-lg border-2 border-white ${service.is_free
                    ...
                    <CardHeader className={service.image_url ? 'pb-2' : ''}>
                      <div className="flex justify-between items-start">
                        ...
                        {!service.image_url && (
                          <div
                            className={`px-3 py-1 rounded-full text-sm font-medium ${service.is_free
