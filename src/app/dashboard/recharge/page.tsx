                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {planCategories.map((category) => (
                          <button
                            ...
                            className={`px-3 py-2 text-sm rounded-lg transition-all font-medium ${selectedCategory === category
                    ...
                    {filteredPlans.length === 0 ? (
                      ...
                      filteredPlans.map((plan) => (
                        <div
                          ...
                          className={`p-4 border-2 rounded-lg cursor-pointer transition-all hover:shadow-md ${selectedPlan?.plan_id === plan.plan_id
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {filteredPlans.map((plan) => (
                <div
                  key={plan.plan_id}
                  onClick={() => handlePlanSelect(plan)}
                  className={`p-4 border-2 rounded-lg cursor-pointer transition-all hover:shadow-lg ${selectedPlan?.plan_id === plan.plan_id
                      ? 'border-blue-600 bg-blue-50 shadow-lg'
                      : 'border-gray-200 hover:border-blue-300'
                    }`}
                >
