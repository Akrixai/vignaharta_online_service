                    ...
                    <tr key={txn.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-col sm:flex-row gap-2">
                          ...
                          {/* Show View Receipt button for successful ELECTRICITY transactions */}
                          {txn.status === 'SUCCESS' && txn.service_type === 'ELECTRICITY' && (
                            <button
                              onClick={() => router.push(`/dashboard/recharge/electricity/receipt?txn=${txn.id}`)}
