...
export default function WaterBillPage() {
  ...
  const fetchOperators = async () => {
    try {
      const res = await fetch('/api/recharge/operators?service_type=WATER');
      const data = await res.json();
      if (data.success) {
    ...
    try {
      ...
      if (data.success) {
        ...
        if (status === 'SUCCESS') {
          ...
          const finalSuccessMsg = `✅ ${cleanMessage}! Your water bill payment for ${primaryNumber} was successful.${operatorRef ? `\nRef: ${operatorRef}` : ''}`;
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-7xl">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-gray-800">💧 Water Bill Payment</h1>
        ...
        {currentStep === 1 ? (
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
            <h2 className="text-xl font-bold mb-4 text-gray-800">Step 1: Select Your Water Provider</h2>
            
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Select Water Provider
              </label>
              <SearchableSelect
                ...
                placeholder="Search and select your water provider..."
                required
              />
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                {dynamicFields.length === 0 && (
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      placeholder="Enter your water consumer number"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      required
                    />
                  </div>
              ...
              >
                {loading ? '⏳ Processing Payment...' : `🚀 Pay Water Bill - ₹${amount || '0'}`}
              </button>
