...
export default function BroadbandBillPage() {
  ...
  const fetchOperators = async () => {
    try {
      const res = await fetch('/api/recharge/operators?service_type=BROADBAND');
      const data = await res.json();
      if (data.success) {
  ...
  const fetchBill = async () => {
    if (!consumerNumber || !selectedOperator) {
      setMessage('Please enter consumer number and select operator');
    ...
    try {
      ...
      if (data.success) {
        ...
        if (status === 'SUCCESS') {
          ...
          const finalSuccessMsg = `✅ ${cleanMessage}! Your broadband bill payment for ${consumerNumber} was successful.${operatorRef ? `\nRef: ${operatorRef}` : ''}`;
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-7xl">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-gray-800">🌐 Broadband Bill Payment</h1>

        {/* Header */}
        <div className="mb-4 sm:mb-6">
          <div className="bg-purple-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold text-sm sm:text-base text-center">
        ...
        {currentStep === 1 ? (
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
            <h2 className="text-xl font-bold mb-4 text-gray-800">Step 1: Select Your Broadband Provider</h2>
            ...
            <div className="mb-6">
              ...
              <SearchableSelect
                ...
                placeholder="Search and select your broadband provider..."
                required
              />
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                {dynamicFields.length === 0 && (
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      placeholder="Enter your broadband customer ID or account number"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                      required
                    />
                  </div>
              ...
              >
                {loading ? '⏳ Processing Payment...' : `🚀 Pay Broadband Bill - ₹${amount || '0'}`}
              </button>
