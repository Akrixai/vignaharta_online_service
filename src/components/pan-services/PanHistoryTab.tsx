...
export default function PanHistoryTab({ walletBalance, onWalletUpdate, router }: PanHistoryTabProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center">
            ...
            <div>
              <div className="text-2xl font-bold text-blue-900">{monitoringStats.total || services.length}</div>
          ...
          <div className="flex items-center">
            ...
            <div>
              <div className="text-2xl font-bold text-green-900">
                {monitoringStats.success || services.filter(s => s.status === 'SUCCESS').length}
              </div>
      ...
      {filteredServices.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredServices.map((service) => (
            <div key={service.id} className="bg-gray-50 rounded-lg border border-gray-200 p-6">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                    ...
                    {service.inspay_txid && (
                      <div>
                        ...
                        <p className="font-mono font-medium text-purple-600">{service.inspay_txid}</p>
                      </div>
                    )}
                  </div>
                  ...
                  {service.webhook_received_at && service.status !== 'SUCCESS' && (
                    <div className={`mt-3 p-3 rounded-lg border bg-blue-50 border-blue-200`}>
                      ...
                      <p className={`text-xs mt-1 text-blue-600`}>
                        Application progress update received from NSDL server
                      </p>
                    </div>
                  )}
