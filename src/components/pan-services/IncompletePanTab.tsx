                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium rounded-full ${app.status === 'PROCESSING' ? 'bg-blue-100 text-blue-800' : 'bg-yellow-100 text-yellow-800'
                          }`}>
                          {app.status}
                        </span>
                      ...
                      {/* Real-time callback activity in Incomplete tab */}
                      ...
                      {app.webhook_received_at && (
                        <div className="mb-3 flex items-center gap-1 text-[10px] text-green-600 font-medium italic">
                          <span>🔄 Callback received: {new Date(app.webhook_received_at).toLocaleTimeString()}</span>
                        </div>
                      )}
